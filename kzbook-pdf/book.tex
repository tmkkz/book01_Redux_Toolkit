...
\def\@pubevent{技術書典10（2021年夏）新刊}
\def\@latestpubhistory{2021年6月25日　ver 1.0}
\makeatother
\author{気分はもう　著}
\date{2021{-}06{-}25 版\hspace{2zw} 発行}
%%%
\begin{titlepage}
  ...
  \mbox{} \vskip5zw
   \reviewtitlefont%
    ...
    {\LARGE
      ...
      \end{tabular}\par}%
    \vfill
    {\large 2021{-}06{-}25 版\hspace{2zw} 発行\par}%
\vskip4zw\mbox{}
  \end{center}%
  \fi                    %%%%%%%%%%
\end{titlepage}
...
\mainmatter
\input{01-createDevEnv.tex}
\input{02-create-react-app.tex}
\input{03-todo-with-react.tex}
...
\ifdefined\mycolophon  %%%%%%%%%%
  ...
  \def\colophonokuduke{%
    \startercolophonrow{著　者}{気分はもう}
%
  }
  \def\colophonrights{%
    
    {\textcopyright} 2020 気分はもう\\
