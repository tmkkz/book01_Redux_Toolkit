...
\starterimageframe{%
\includegraphics[width=0.4\maxwidth]{./images/03-todo-with-react/diary01.png}%
}%
...
\end{starternote}
\begin{reviewimage}[H]%%yaruo-ui01
...
\begin{reviewimage}[H]%%mui005-albumLayout
...
\begin{reviewimage}[H]%%mui006-albumLayoutSource
...
\begin{reviewimage}[H]%%mui007-albumLayoutSourceCode
...
\begin{reviewimage}[H]%%yaruo-ui02
...
\begin{reviewimage}[H]%%mui009-card-ComplexInteraction
...
\reviewcolumnhead{}{import * as React呪文}
\addcontentsline{toc}{subsection}{\numberline{[コラム]}import * as React呪文}
...
\begin{reviewimage}[H]%%sec00332-6
...
\def\startercodeblockfontsize{}
\begin{starterprogram}[]{DiaryCardコンポーネントのCardHeaderがあった部分}\seqsplit{   return (
...
\subsubsection*{DiaryCarHeaderコンポーネントにメニューを組み込む}
\keeplastskip{
  \label{sec:3-3-6-1}
  \label{sec-0336-1}
  \par\nobreak
...
\begin{reviewimage}[H]%%mui013-card-deleteDialog
...
\begin{reviewimage}[H]%%mui014-card-deleteDialog-done
...
\begin{reviewimage}[H]%%AppComponents
...
\begin{reviewimage}[H]%%propsDrilling
...
\begin{reviewimage}[H]%%propsDrilling01
...
\begin{reviewimage}[H]%%understand
