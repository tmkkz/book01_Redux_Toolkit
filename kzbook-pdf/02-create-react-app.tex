...
\def\startercodeblockfontsize{}
\begin{starterterminal}[]{create{-}react{-}app完了時}\seqsplit{  Success! Created yaruo{-}cra{-}template at /Users/kazuyainaba/Documents/Devs\textunderscore{}kz/Project\textunderscore{}技術書展202012/yaruo\textunderscore{}react\textunderscore{}sample/yaruo{-}cra{-}template
...
\includegraphics[width=1.0\maxwidth]{./images/02-create-react-app/babel06.png}%
