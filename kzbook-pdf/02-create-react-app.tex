...
\includegraphics[width=0.5\maxwidth]{./images/02-create-react-app/oneCommand.png}%
...
\includegraphics[width=0.5\maxwidth]{./images/02-create-react-app/noMatter.png}%
...
\includegraphics[width=0.4\maxwidth]{./images/02-create-react-app/ok2.png}%
