...
\begin{starterprogram}[_984064844]{リスト1.1: }\seqsplit{  const http = require('http');
...
\def\startercodeblockfontsize{}
\begin{starterterminal}[_022103517]{リスト1.2: app.jsを実行}\seqsplit{  \textgreater{} node app.jp
...
\def\startercodeblockfontsize{}
\begin{starterterminal}[_080915400]{リスト1.3: nvmのインストール}\seqsplit{  \textgreater{}curl {-}o{-} https://raw.githubusercontent.com/nvm{-}sh/nvm/v0.39.0/install.sh \textbar{} bash}\end{starterterminal}
