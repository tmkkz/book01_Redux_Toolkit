...
\def\startercodeblockfontsize{}
\begin{starterterminal}[_836115523]{リスト1.2: app.jsを実行}\seqsplit{  ❯ node test01.js
...
\def\startercodeblockfontsize{}
\begin{starterterminal}[_507128994]{リスト1.3: nvmのインストール}\seqsplit{  \textgreater{}curl {-}o{-} https://raw.githubusercontent.com/nvm{-}sh/nvm/v0.39.0/install.sh \textbar{} bash}\end{starterterminal}
...
\begin{reviewimage}[H]%%waiting
\includegraphics[width=0.5\maxwidth]{./images/01-createDevEnv/waiting.png}%
\label{image:01-createDevEnv:waiting}
\end{reviewimage}
