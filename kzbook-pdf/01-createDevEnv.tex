...
\def\startercodeblockfontsize{}
\begin{starterterminal}[_958988118]{リスト1.2: app.jsを実行}\seqsplit{  ❯ node test01.js
...
\def\startercodeblockfontsize{}
\begin{starterterminal}[_934173795]{リスト1.3: nvmのインストール}\seqsplit{  \textgreater{}curl {-}o{-} https://raw.githubusercontent.com/nvm{-}sh/nvm/v0.39.0/install.sh \textbar{} bash}\end{starterterminal}
