...
\def\startercodeblockfontsize{}
\begin{starterterminal}[_503904696]{リスト1.2: app.jsを実行}\seqsplit{  ❯ node test01.js
...
\def\startercodeblockfontsize{}
\begin{starterterminal}[_362466168]{リスト1.3: nvmのインストール}\seqsplit{  \textgreater{}curl {-}o{-} https://raw.githubusercontent.com/nvm{-}sh/nvm/v0.39.0/install.sh \textbar{} bash}\end{starterterminal}
