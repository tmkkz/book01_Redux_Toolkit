...
\begin{starterprogram}[_862077035]{リスト1.1: }\seqsplit{  const http = require('http');
...
\def\startercodeblockfontsize{}
\begin{starterterminal}[_824521234]{リスト1.2: app.jsを実行}\seqsplit{  \textgreater{} node app.jp
...
\def\startercodeblockfontsize{}
\begin{starterterminal}[_347960161]{リスト1.3: nvmのインストール}\seqsplit{  \textgreater{}curl {-}o{-} https://raw.githubusercontent.com/nvm{-}sh/nvm/v0.39.0/install.sh \textbar{} bash}\end{starterterminal}
...
\section{Package Manager(npm,yarn)}
\keeplastskip{
  \label{sec:1-2}
  \label{sec-yarn}
  \par\nobreak
...
パッケージマネージャーに「Chocolatey」をお使いの方は、\\[0pt]
